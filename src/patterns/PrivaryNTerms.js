...
const PrivaryNTerms = () => {
  ...
  useEffect(() => {
    document.title = "Privacy Policy | DeWall Street";
  }, []);
  ...
  const renderService = (
    <div className="privacyNterms_details_service">
      ...
      <div className="text_secondaryLite_14">
        <p className="mb-30">
          By using Linux Foundation websites you are agreeing to be bound by the following terms and
          conditions here.
        </p>{" "}
        ...
        <ul>
          ...
          <li>
            Don’t post just to sell something. Sure, talk up your project, but don’t mention how to
        ...
        <p className="mb-30">
          ...
          endorsements of the Linux Foundation, its staff, or its members. We recognize there may be
          inaccurate information reflected in this site and that users should understand that
          something that appears on Linuxfoundation.org does not mean the Linux Foundation has
          vetted or endorsed that content.
        </p>
        <p>
          Linux Foundation reserves the right to take down anything you post on this site, for these
          or other reasons. If you don’t agree to these terms, don’t use this website. Violation of
          the terms in this document may result in the removal of the content and a warning from the
          site’s administrators. A second violation will result in the removal of your user account.
        </p>
      </div>
    </div>
  );
